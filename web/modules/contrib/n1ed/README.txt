...
Powers up your TinyMCE and CKEditor with widgets, the handy fullscreen mode, and support for responsive controls.
Features its own add-on ecosystem. Keeps compatibility with all standard add-ons and the API of the editor.
